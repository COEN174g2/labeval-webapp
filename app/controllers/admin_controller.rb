class AdminController < ApplicationController
  ...
  def sendemail
    ...
    system( "echo 'This is a reminder that you have not completed the evaluation for COEN 174L yet. Click here to complete: http://localhost:3000/login' | mail -s 'Lab Evaluation Reminder' jluo1@scu.edu | heroku run console --app=labeval --no-tty" )
  end

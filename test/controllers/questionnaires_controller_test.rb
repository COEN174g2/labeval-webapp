...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { cid: @questionnaire.cid, name: @questionnaire.name, professor_id: @questionnaire.professor_id } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { cid: @questionnaire.cid, name: @questionnaire.name, professor_id: @questionnaire.professor_id } }
